    			...
    			<div class="col-sm-10">
    					...
    					<div class="panel panel-primary">
						  ...
						  <div class="panel-body">
						   	 <center><a href="${pageContext.request.contextPath}/admin/batches/add" class="btn btn-info btn-lg">生成新批次</a></center>
						  </div>
						</div><!-- 生成试卷 -->
						  ...
						  <div class="panel-body">
						    	<table class="table table-hover table-striped table-bordered">
						    		...
						    		<c:forEach items="${batchesList }" var="b">
						    			<tr>
						    				<td><a target="_blank" href="${pageContext.request.contextPath}/admin/batches/show/${b.id}">${b.name }</a></td>
						    				<td>${b.season}</td>
