					...
					<div class="panel-body">
						<form
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input type="text" class="form-control inputxt" name="title"
										id="username">
								</div>
							</div>
								...
								<div class="col-xs-10" id="item">
									...
									<div class="col-xs-4">
										<button class="btn btn-primary" id="addItem">
											<span class="glyphicon glyphicon-plus-sign" aria-hidden="true">添加新表单项</span>
										</button>
									</div>
								...
								<div class="col-xs-10" id="tableItem">
									...
									<div class="col-xs-3">
										<button class="btn btn-primary" id="addTableItem">
											<span class="glyphicon glyphicon-plus-sign" aria-hidden="true">添加表格新条目</span>
										</button>
									</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-10" id="question">
									...
									<div class="col-xs-3">
										...
										<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"> 添加问题</span>
