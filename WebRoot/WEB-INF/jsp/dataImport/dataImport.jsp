        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                <div class="alert alert-warning">导入文件前请先查看右侧的文件上传说明！文件上传前必须进行
                    <a  target="_blank" href="${pageContext.request.contextPath}/image/tqe-excel-upload-convert.jpg">格式转换</a>！</div>
                <div class="col-sm-9">
                ...
                <div class="col-sm-3">
                    <div class="well text-danger">
                        ...
                        <ul>
                            ...
                            <li><a target="_blank" href="${pageContext.request.contextPath}/image/tqe-excel-upload-convert.jpg"
